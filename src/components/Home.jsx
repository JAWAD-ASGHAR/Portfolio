...
const socials = [
  { id: 1, href: "https://github.com/JAWAD-ASGHAR", icon: <TbBrandGithubFilled color="black" />, text: "GitHub" },
  { id: 2, href: "https://www.linkedin.com/in/jawad-a-dev/", icon: <FaLinkedin color="black" />, text: "LinkedIn" },
    ...
    <>
      ...
      >
        <div className="pt-16 flex flex-col items-center">
          ...
          <h1 className="text-aliceblue text-6xl font-bold mt-6">Designer / Developer</h1>
        </div>
      </div>
          ...
          {socials.map((social) => (
           <Tooltip text={social.text}>
             <li
               ...
               className={`h-10 rounded-full justify-center items-center flex w-10 bg-white ${social.href === "#" ? "cursor-not-allowed" : "hover:cursor-pointer"} hover:opacity-80 duration-300 transition-all ease-in-out`}
               key={social.id}
             >
              {social.icon}
            </li>
